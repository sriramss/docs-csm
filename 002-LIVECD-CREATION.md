...
7. [Enable networking on first boot of the livecd](#manual-step-7-enable-netwrking-on-first-boot-of-the-livecd)
8. [Populate the LiveCD with the payload](#manual-step-7-populate-lived)
9. [Boot into the LiveCD](#manual-step-8-boot-into-your-livecd)
...
### Manual Step 8: Enable networking on first boot of the livecd
